...
# See https://astroquery.readthedocs.io/en/latest/simbad/simbad.html#:~:text=in%20the%20list.-,Query%20to%20get%20all%20names%20(identifiers)%20of%20an%20object,-%C2%B6 for more details
...
def online_alias_search(queue):
    ...
    for i, name in enumerate(queue):
        ...
        #Rest the search so we don't get black listed from SIMBAD    
        if i % 3 == 0:
            time.sleep(3)
        else:
            time.sleep(1)
